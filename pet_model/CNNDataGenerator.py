"""
Generates data on the fly for Keras model
"""
import numpy as np
import keras
import sys
...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, list_IDs, labels, batch_size=32, dim=(182, 218,  182), n_channels=1,
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        for i, ID in enumerate(list_IDs_temp):
            # Store sample
            sample = np.load('/home/ubuntu/training/PET/' + str(ID))
